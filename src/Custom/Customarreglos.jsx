...
const TallaCamisasnew = ['all',...TallaCamisas];
...
const TallaZapatosnew = ['all',...TallaZapatos];
...
const TallaVestidosnew = ['all',...TallaVestidos]
...
const TallaFaldasnew = ['all',...TallaFaldas];
...
const TallaPantalonesnew = ['all',...TallaPantalones];
...
const ColorCamisasnew = ['all',...ColorCamisas];
...
const ColorZapatosmew = ['all',...ColorZapatos];
...
const ColorVestidosnew = ['all',...ColorVestidos];
...
const ColorFaldasnew = ['all',...ColorFaldas];
...
const ColorPantalonesnew = ['all',...ColorPantalones];
